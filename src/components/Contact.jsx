      ...
      <div className="container">
        ...
        <div className="contact-grid">
          <motion.div initial={{opacity:0,x:-30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{duration:0.5}}>
            ...
            <div className="contact-detail"><div className="contact-detail-icon"><FiMail/></div><div><div className="contact-detail-label">Email</div><div className="contact-detail-value">shrinivaspatil@csufullerton.edu</div></div></div>
            ...
            <div className="contact-socials">
              ...
              <a href="mailto:shrinivaspatil@csufullerton.edu" className="contact-social" aria-label="Email"><FiMail/></a>
            </div>
          </motion.div>
          <motion.form ref={ref} className="contact-form" onSubmit={hs} initial={{opacity:0,x:30}} whileInView={{opacity:1,x:0}} viewport={{once:true}} transition={{duration:0.5}}>
            ...
            {st==='error'&&<p className="form-error">❌ Something went wrong. Please email me directly.</p>}
          </motion.form>
        </div>
      </div>
    </section>
